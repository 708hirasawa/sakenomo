	...
	print('<div id="all_container">');
		print('<div id="main_container">');
			...
			print('<div class="section">');
				...
				print('<div class="item">●「Sakenomo会員」とは、Sakenomoを利用するために、運営者所定の会員手続きを完了したお客様のことをいいます。</div>');
				...
				print('<div class="item">●「運営者」とは、Sakenomoサイトを運営する者をいいます。</div>');
			print("</div>");
			...
			print('<div class="section">');
				...
				print('<div class="item">(3) その他運営者が定める規約</div>');
				print('<div class="text">個別規約と本規約の間に矛盾または抵触がある場合には、個別規約の規定が優先的に適用されるものとします。</div>');

				print('<div class="sub_title">(Sakenomo規約の変更)</div>');
				print('<div class="text">3.2. Sakenomo規定は、運営者がその裁量により必要または適切であると判断する場合には、その全部または一部が予告なく変更されることがあります。かかる変更等により、お客様または第三者に生じた損害について、運営者は一切の責任を負わないものとします。運営者がSakenomoサイト上での告知を含む適宜の方法によりSakenomo規約の変更を告知した後に、お客様がSakenomoを利用した場合には、変更後の規約を承認したものとみなされます。</div>');
			...
			print('<div class="section">');
				...
				print('<div class="text">4.1. Sakenomoは、運営者が提供する日本酒に関する情報、またはお客様が投稿する日本酒に関する情報を、ウェブサイト上に掲載することによって、他のお客様が日本酒に対する理解を高め、日本酒選びの際の参考等とすることを目的にしています。</div>');

				print('<div class="sub_title">(サービスの変更)</div>');
				print('<div class="text">4.2. 運営者がその裁量により必要または適切と判断する場合は、Sakenomoの内容を予告なく変更、中止、中断できるものとします。</div>');
				...
				print('<div class="text">4.4. お客様がSakenomoを利用する際に必要となる、パソコン、スマートフォン、インターネット環境等については、お客様自らの費用で用意し、操作するものとします。運営者は、お客様がウェブサイトにアクセスための準備や操作方法に関与しません。</div>');

				print('<div class="sub_title">(利用可能なサービスの範囲)</div>');
				print('<div class="text">4.5. Sakenomoは、会員登録をせずにご利用いただくことができますが、Sakenomo会員とSakenomo非会員では、利用可能なサービスの範囲が異なる場合があります。Sakenomo会員向け、Sakenomo非会員向けそれぞれに利用可能なサービスの範囲については、運営者が決定し、予告なしに変更できるものとします。</div>');

				print('<div class="sub_title">(会員登録手続き)</div>');
				print('<div class="text">4.6. Sakenomo会員になることを希望するお客様は、Sakenomo規約および適用される諸条件に同意し、運営者所定の手続きを行うことで、Sakenomo会員の申し込みができるものとします。</div>');

				print('<div class="sub_title">(会員手続きの完了)</div>');
				print('<div class="text">4.7. Sakenomo会員登録は、運営者がSakenomo会員申し込みを承諾することにより完了します。次のいずれかに該当する場合、運営者の判断により、会員申し込みを承諾しないことがあります。</div>');
				...
				print('<div class="item">(4) その他運営者が不適切と判断した場合</div>');

				print('<div class="sub_title">(アカウント等の情報管理)</div>');
				print('<div class="text">4.8. Sakenomo会員は、アカウント名やパスワード等の情報をご自身で責任を持って管理するものとし、運営者はお客様の管理不足、使用上の過誤、不正確な登録情報等に起因する損害について、一切責任を負わないものとします。</div>');

				print('<div class="sub_title">(ガイドライン)</div>');
				print('<div class="text">4.9. お客様は、運営者が別途定めるガイドラインに沿って、Sakenomoを利用するものとします。ガイドラインに反するものが判明した場合は、運営者は予告なしに投稿等を削除できるものとし、削除に該当するかどうかは運営者で判断します。</div>');
			print("</div>");

			print('<div class="section">');
				print('<div class="title">5. 個人情報取り扱い</div>');
				print('<div class="sub_title">(プライバシーポリシー)</div>');
				print('<div class="text">5.1. 運営者の個人情報取り扱いについては、運営者が別途定める<a href="privacy_policy.php">プライバシーポリシー</a>をご覧ください。お客様は、プライバシーポリシーに沿って、Sakenomoを利用するものとします。</div>');
			print("</div>");

			print('<div class="section">');
				print('<div class="title">6. 知的財産権等</div>');
				print('<div class="sub_title">(知的財産権の帰属)</div>');
				print('<div class="text">6.1. Sakenomoサイト上のコンテンツ、デザイン、ロゴ、画像、ソフトウェア等に関する著作権、商標権、財産権等を含む知的財産権は、運営者に帰属しています。運営者もしくは法令により許諾されている場合を除き、Sakenomoサイト上のすべての内容において、お客様が複製、編集、掲載、転載、提供、翻訳、転売等を行うことは禁止されています。</div>');

				print('<div class="sub_title">(知的財産権に起因する損害等)</div>');
				print('<div class="text">6.2. お客様が知的財産権に反する行為により損害を被った場合、運営者は一切の責任を負わないものとします。また、当該行為によって、利益を得た場合、運営者はその利益相当額を請求できるものとします。</div>');

				print('<div class="sub_title">(お客様が投稿したコンテンツの著作権の帰属)</div>');
				print('<div class="text">6.3. お客様が投稿した口コミや写真を含むコンテンツの著作権は、運営者に帰属するものとし、その期間は、投稿時から当該著作権の存続期間の満了日までとします。</div>');

				print('<div class="sub_title">(お客様が投稿したコンテンツの無償利用)</div>');
				print('<div class="text">6.4. 運営者は、お客様が投稿した口コミや写真を含むコンテンツを無償にて利用できるものとします。その際に運営者は、お客様の口コミの要約や抜粋、写真の切り取り等を行う場合があり、地域制限、その他付随条件なく、利用できるものとします。</div>');
			print("</div>");
			...
			print('<div class="section">');
				...
				print('<div class="item">(7) 運営者または他のお客様の権利を侵害すること</div>');
				print('<div class="item">(8) 公序良俗に反すること</div>');
				print('<div class="item">(9) 異性との出会い等を目的に利用すること</div>');
				print('<div class="item">(10) Sakenomoの運営を妨げること、または運営者の信用を毀損すること</div>');
				print('<div class="item">(11) その他、運営者が不適切と判断すること</div>');

				print('<div class="sub_title">(禁止行為に対しての措置)</div>');
				print('<div class="text">7.2. お客様が前項各号の行為を行ったと運営者が判断した場合、運営者は投稿情報の削除措置、Sakenomo利用停止措置、またはその他運営者が適切と判断する措置を取ることができるものとします。当該措置は、運営者の裁量で行うものとし、その理由については、お答えいたしかねます。また、当該措置によって、お客様が被った損害について、運営者は一切の責任を負わないものとします。</div>');
			print("</div>");

			print('<div class="section">');
				print('<div class="title">8. 退会手続き</div>');
				print('<div class="sub_title">(退会手続き)</div>');
				print('<div class="text">8.1. Sakenomo会員が退会を希望する場合は、運営者所定の退会手続きを行うものとします。</div>');

				print('<div class="sub_title">(退会による会員資格の失効)</div>');
				print('<div class="text">8.2. Sakenomo会員が退会手続きを行った時点で、運営者で利用いただいていた、Sakenomo会員の特典や権利などの会員資格を失うものとします。</div>');

				print('<div class="sub_title">(退会後の投稿コンテンツ)</div>');
				print('<div class="text">8.3. Sakenomo会員が退会後も、投稿したコンテンツや写真等は削除されず、当該コンテンツや写真等の著作権は運営者に帰属するものとします。</div>');
			...
			print('<div class="section">');
				...
				print('<div class="text">9.1. 他に定める場合のほか、天災、地震、火災、洪水、テロ、暴動、停電、システム故障、ネットワーク障害、その他運営者の責めによらない事由に基づくSakenomoの提供の停止、遅滞、不具合、中断による損害について、運営者は責任を負わないものとします。</div>');
				...
				print('<div class="text">9.3. 運営者は、Sakenomoサイト上のすべての情報について、保証をいたしません。Sakenomoサイト上の情報が起因して起こった損害(コンピューターウィルス等も含みます)やお客様同士のトラブルについて、運営者は一切の責任を負わないものとします。記載情報に誤りがある場合は、問い合わせフォームよりご連絡ください。</div>');

				print('<div class="sub_title">(記載情報の削除)</div>');
				print('<div class="text">9.4. 運営者は、運営者が不適切と判断する情報を発見した場合、予告なく削除することがあり、その判断は運営者の裁量で行うものとします。判断の理由については、説明いたしかねます。</div>');

				print('<div class="sub_title">(第三者運営のサイト)</div>');
				print('<div class="text">9.5. Sakenomoサイトに投稿された第三者運営のサイトへのリンクについて、運営者は一切保証をしないものとします。リンク先で生じたトラブルや損害等についても、運営者は一切の責任を負いません。</div>');

				print('<div class="sub_title">(責任制限)</div>');
				print('<div class="text">9.6. 運営者は、運営者に重過失があった場合を除き、直接損害以外の損害（間接損害、付随的損害、特別損害、懲罰的損害、結果損害、データの損失または消失を含みますが、これらに限られません）については、責任を負いません。</div>');

				print('<div class="sub_title">(限定保証)</div>');
				print('<div class="text">9.7. 運営者は、Sakenomoの全部または一部が停止または中断されずに提供されること、または瑕疵のないことを保証しません。</div>');
			print("</div>");
			...
			print('<div class="section">');
				...
				print('<div class="text">10.2. お客様と運営者との間で訴訟の必要が生じた場合、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</div>');
			print("</div>");
