...
<html>
	...
	<?php
	define('REDIRECT_URL', 'https://sakenomo.com/cgi/signup.php?token=');
    ...
    ***********************************************/
	...
	$sql = "INSERT INTO PRE_USERS(id, email, password, token, date, flag) VALUES ('$id', '$email', '$password', '$token', '$in_time', 0)";
	$res = executequery($db, $sql);
